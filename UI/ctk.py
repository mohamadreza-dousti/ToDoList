...
class Ui(ctk.CTk):
    def __init__(self):
        ...
        self.display = ctk.CTkScrollableFrame(self, width=450, height=250,
                                            corner_radius=10)
    ...
    def AddTask(self):
        ...
        values = ['very high', 'high', 'mid', 'low']
        priority_var = ctk.StringVar(value='priority')
        priority = ctk.CTkOptionMenu(self.display, width=350, height=40,corner_radius=10,
                                     variable=priority_var, values=values)
    ...
    def ShowTasks(self):
        ...
        self.display.grid_columnconfigure(5, weight=1)
        ...
        for task in tasks:
            ...
            task_label.grid(row=ctr, column=0, columnspan=2)
            ...
            remove_vars[f'remove_btn{ctr}'].grid(row=ctr, column=2)
            ...
            show_vars[f'show_task{ctr}'].grid(row=ctr, column=3)
            ...
            dirlist.save_priority(task_label, self.display, ctr, priority_vars)
        ...
        refresh_btn.grid(row=ctr, column=3, columnspan=3)
